...
# Configuration Script – NLM - Rev. A

This **Configuration** script is designed for the **NLM** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – NLM Rev. A

Este script de **Configuration** está diseñado para el modelo **NLM** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
